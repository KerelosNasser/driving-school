...
# Authentication
NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY=your_clerk_publishabl
e_key
...
3. 3.
   ...
   ```
   -- Copy and paste contents of sql/seed.sql
   ```
...
### Step 6: AI Chatbot Setup
1. 1.
   Create Hugging Face account
2. 2.
   Get API token
3. 3.
   Configure model preferences in the chatbot component
...
Built with ❤️ using modern web technologies for professional driving school operations.