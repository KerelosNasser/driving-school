...
export function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-r from-emerald-900 via-teal-800 to-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Trust Stats - Mobile Friendly */}
        <div className="py-6 border-b border-emerald-700/30">
          <div className="grid grid-cols-3 gap-4 text-center">
            {trustStats.map((stat) => (
              <div key={stat.label} className="space-y-2">
                <div className="inline-flex items-center justify-center w-10 h-10 bg-gradient-to-r from-emerald-600 to-teal-700 rounded-full">
                  <stat.icon className="h-5 w-5 text-white" />
                </div>
                <div className="text-lg font-bold text-emerald-300">{stat.value}</div>
        ...
        <div className="py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4 md:col-span-2 lg:col-span-1">
              ...
              <div className="flex space-x-3">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" 
                   className="text-emerald-200 hover:text-blue-300 transition-colors p-2 rounded-full hover:bg-white/10">
                  <Facebook size={18} />
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                   className="text-emerald-200 hover:text-pink-300 transition-colors p-2 rounded-full hover:bg-white/10">
                  <Instagram size={18} />
                </a>
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter"
                   className="text-emerald-200 hover:text-blue-200 transition-colors p-2 rounded-full hover:bg-white/10">
                  <Twitter size={18} />
                </a>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-emerald-300">Quick Links</h3>
            ...
            {/* CTA Section */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-emerald-300">Get Started</h3>
              ...
              <div className="space-y-2">
                <Link 
                  href="/service-center" 
                  className="block w-full bg-gradient-to-r from-emerald-600 to-teal-700 hover:from-emerald-700 hover:to-teal-800 text-white font-medium py-2 px-4 rounded-lg transition-all duration-300 text-center text-sm shadow-lg hover:shadow-emerald-500/25"
                >
                  Book Now
                </Link>
                <Link 
                  href="/packages" 
                  className="block w-full border border-emerald-500/50 text-emerald-100 hover:bg-emerald-800/50 hover:text-white font-medium py-2 px-4 rounded-lg transition-all duration-300 text-center text-sm backdrop-blur-sm"
                >
                  View Packages
                </Link>
              </div>
        ...
        <div className="border-t border-emerald-700/30 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            ...
            <div className="flex space-x-4 text-xs">
              <Link href="/privacy" className="text-emerald-200/80 hover:text-emerald-100 transition-colors">
                Privacy
              </Link>
              <Link href="/terms" className="text-emerald-200/80 hover:text-emerald-100 transition-colors">
                Terms
              </Link>
            </div>
          </div>
